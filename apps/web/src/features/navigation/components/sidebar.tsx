...
const Sidebar = () => (
  <>
    ...
    <nav
      ...
      aria-live="polite"
      className="sidebar group fixed top-(--header-height) bottom-0 left-0 z-20 hidden w-(--side-width) overflow-x-clip border-r px-3 py-2 transition-all duration-200 hover:w-(--expanded-sidebar-width) md:block"
    >
