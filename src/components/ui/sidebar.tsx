...
// biome-ignore lint/style/noMagicNumbers: pretty well explained
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (nextOpenOrUpdater: boolean | ((current: boolean) => boolean)) => {
      const openState =
        typeof nextOpenOrUpdater === "function"
          ? nextOpenOrUpdater(open)
          : nextOpenOrUpdater;
      if (setOpenProp) {
...
function SidebarMenuSkeleton({
  ...
  const width = React.useMemo(() => {
    return `${
      // biome-ignore lint/style/noMagicNumbers: a random number as commented just above
